...
export const tableRu: TableDict = {
  ...
  mod: {
    coowner: 'совладелец',
    coownerTitle: 'Выбран столом, пока хозяин отсутствует; может удалять игроков',
    kickTitle: (name) => `Удалить ${name} со стола - их место займёт бот`,
    kickSure: 'Точно?',
    awayTitle: 'Хозяин стола отошёл',
    awayBody: (name, voters) =>
      `${name} давно нет. Поддержите совладельца, чтобы за столом был порядок; нужно больше половины из ${voters}.`,
