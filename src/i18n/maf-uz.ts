...
export const mafUz: MafDict = {
  ...
  ui: {
    ...
    cards: {
      ...
      sleep: 'Uyqu',
      peek: 'Rol',
      hide: 'Rolni yashirish',
      pick: 'O‘ynash uchun qo‘lingizdagi kartani bosing.',
      aim: 'yonib turgan o‘yinchini bosing yoki kartani uning ustiga suring',
      ...
      voteHint: 'Byulleteningizni tashlang: o‘yinchini bosing. Qaytarib olish uchun yana bosing.',
      voted: (name: string): string => `Byulleteningiz ${name} ustida. Ko‘chirish uchun boshqasini bosing.`,
