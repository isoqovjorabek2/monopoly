...
export const accountEn = {
  ...
  plus: {
    ...
    ads: {
      label: 'Advertisement',
      watch: 'Watch a short video to play this game on Tashkent or Europe',
      watching: 'Playing the video…',
      trialOn: 'Opened for this game by a video. Plus opens the boards for good.',
      unavailable: 'No video right now - try again in a minute.',
      skipped: 'The boards open once the video plays to the end.',
      noAds: 'No ads with Plus',
    },
    finishLabel: 'Finish',
